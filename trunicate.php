...
<center><h1 class="rainbowize">Data Reset</h1></center>

<?php

	if ($current_user == "admin" or $current_user =="ItalianoBaffi" or $current_user =="root") {
		echo "<center>";
		$result = mysqli_query($database,"truncate 2017_game.mytable;");
    	$result = mysqli_query($database,"ALTER TABLE 2017_game.mytable AUTO_INCREMENT = 1;");
