		...
		<div class="col-md-12 column">
			<div class="row clearfix">
				<?php
					...
					$sql = "SELECT * FROM user WHERE user_username != '$current_user' order by user_timescouted desc";
								...
								<div id="panel-element-<?php echo $rws['user_id']; ?>" class="panel-collapse collapse in">
									<div class="panel-body">
										...
										<div class="col-md-6 column">
											...
											<h4><span><a href="profile.php?user_username=<?php echo $rws['user_username'];?>"><?php echo $rws['user_matchscouted'];?> Matches</a></span></h4>
