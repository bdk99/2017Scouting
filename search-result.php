...
<?php
    if($_POST){
        ...
        $sql=mysqli_query($database,"select * from user where user_firstname like '%$query%' or user_lastname like '%$query%' or user_username like '%$query%'");
																...
																<div class="panel-body">
																	...
																	<div class="col-md-6 column">
																		<div class="col-md-12 column">	
																			...
																			<p>Username: <?php echo $rws['user_username'];?></p>
																			<?php	if ($current_user == "admin") { ?>
																				<p>Password: <?php echo $rws['user_password'];?></p>
																				<p>Email: <?php echo $rws['user_email'];?></p>
																				<p>Phone: <?php echo $rws['user_phone'];?></p>
																			<?php }?>
																			<hr>
																			Biography:<p><?php echo $rws['user_shortbio'];?></p>
																			<hr>
																		</div>
