	...
	<body style="margin:0;" onload = "startTimer()">
		...
		<div class="container">
			<div class="row clearfix">
				<h1 name="title" class="rainbowize">Team 3641 Scouting</h1>
				<table width="800" border="0" cellspacing="1" cellpadding="2" style="color=#FF9100">
					...
					<form action="Entry.php" method="post" id="myForm">						
						...
						<?php if ($current_user == "admin" or $current_user =="ItalianoBaffi" or $current_user =="root" or $current_user =="Shiffy") { ?>
							<?php    //get results from database
								...
								if ($number<6 && $number>0 or $number>6)
								{
								?>
					...
					<?php
						...
						{
							$confirm = mysqli_query($database,"SELECT teamnum FROM 2017_game.mytable WHERE matchnum = (select max(matchnum) from 2017_game.mytable matchnum) and ScouterName='$current_user'");
							$confirm2=mysqli_num_rows($confirm);
							if ($confirm2 == 1)
							{?>
							<div class="alert success">
								<span class="closebtn">&times;</span>  
								...
								<tr>
									<td class="center">
										...
										<!--UNCOMMENT FOR HOWELL--><div>	
											...
											<!--UNCOMMENT FOR STATES--FORD DIVISION-->
											<select id="dropdown" <?php if($current_user != "admin"){?> onchange="change" <?php }?> name="TeamNum" id="TeamNum" <?php if($current_user != "admin") {?> required <?php }?> >
												<option value="">Team Number</option>
												<option value="27">27</option>	
												<option value="66">66</option>
				...
				<td class="center">
					<select id="dropdown"  <?php if($current_user != "admin") {?> onchange="change" required  <?php }?> name="Position" id="Position">
				...
				<tr>
					<center>
						...
						<div class="mdl-shadow--2dp" style="padding:5px; width:70%">
							<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio"  name="AutonFuelScoredLow" id="AutonFuelScoredLow"  value="0" class="mdl-radio__button" checked<?php if($current_user != "admin") {?> required <?php }?>><span> None</span></label>
				...
				<tr>
					<center>
						...
						<div class="mdl-shadow--2dp" style="padding:5px; width:70%">
							<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio"  name="AutonFuelScoredHigh" id="AutonFuelScoredHigh"  value="0" class="mdl-radio__button" checked<?php if($current_user != "admin") {?> required <?php }?>><span> None</span></label>
				...
				<tr>
					<center>
						...
						<div class="mdl-shadow--2dp" style="padding:5px; width:70%">
							<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio"  name="AutonFuelHighHopper" id="AutonFuelHighHopper"  value="0" class="mdl-radio__button" checked<?php if($current_user != "admin") {?> required <?php }?> ><span> None</span></label>
				...
				<center>
					<div class="mdl-shadow--2dp" style="padding:5px; width:70%">
						...
						<table1 style="padding:5px">
							...
							<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio"  name="AutonCycle" id="AutonCycle"  value="1" class="mdl-radio__button" checked><span>1</span></label>
				...
				<center>
					<tr>
						<center>
							...
							<h6 class="notice">Notice: If they score high goals... please disregard low goals! (Make Low Goal None)</h6>
							<div class="mdl-shadow--2dp" style="padding:5px; width:70%">
								<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio"  name="TeleopFuelScoredLow" id="TeleopFuelScoredLow"  value="0" class="mdl-radio__button" checked<?php if($current_user != "admin") {?> required <?php }?>><span> None</span></label>
						...
						<tr>
							<center>
								...
								<div class="mdl-shadow--2dp" style="padding:5px; width:70%">
									<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio"  name="TeleopFuelScoredHigh1" id="TeleopFuelScoredHigh1"  value="0" class="mdl-radio__button" checked<?php if($current_user != "admin") {?> required <?php }?>><span> None</span></label>
						...
						<tr>
							<center>
								...
								<div class="mdl-shadow--2dp" style="padding:5px; width:70%">
									<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio" name="TeleopFuelScoredHigh2" id="TeleopFuelScoredHigh2" value="0" class="mdl-radio__button" checked<?php if($current_user != "admin") {?> required <?php }?>><span> None</span></label>
						...
						<tr>
							<center>
								...
								<div class="mdl-shadow--2dp" style="padding:5px; width:70%">
									<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio" name="TeleopFuelScoredHigh3" id="TeleopFuelScoredHigh3" value="0" class="mdl-radio__button" checked<?php if($current_user != "admin") {?> required <?php }?>><span> None</span></label>
						...
						<tr>
							<center>
								<h5>Amount of balls scored in ShootingCycle 4</h5>
								<div class="mdl-shadow--2dp" style="padding:5px; width:70%">
									<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio" name="TeleopFuelScoredHigh4" id="TeleopFuelScoredHigh4" value="0" class="mdl-radio__button" checked<?php if($current_user != "admin") {?> required <?php }?>><span> None</span></label>
									<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio" name="TeleopFuelScoredHigh4" id="TeleopFuelScoredHigh4" value="1" class="mdl-radio__button"><span> Few</span></label>
									<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio" name="TeleopFuelScoredHigh4" id="TeleopFuelScoredHigh4" value="2" class="mdl-radio__button"><span> Less Than Half</span></label>
									<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio" name="TeleopFuelScoredHigh4" id="TeleopFuelScoredHigh4" value="3" class="mdl-radio__button"><span> Half</span></label>
									<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio" name="TeleopFuelScoredHigh4" id="TeleopFuelScoredHigh4" value="4" class="mdl-radio__button"><span> More Than Half</span></label>
									<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio" name="TeleopFuelScoredHigh4" id="TeleopFuelScoredHigh4" value="5" class="mdl-radio__button"><span> Most</span></label>
								</div>
							</center>
						</tr>
						<br>
						<tr>
							<center>
								<h5>Amount of balls scored in ShootingCycle 5</h5>
								<div class="mdl-shadow--2dp" style="padding:5px; width:70%">
									<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px" selected><input type="radio" name="TeleopFuelScoredHigh5" id="TeleopFuelScoredHigh5" value="0" class="mdl-radio__button" checked<?php if($current_user != "admin") {?> required <?php }?>><span> None</span></label>
									<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio" name="TeleopFuelScoredHigh5" id="TeleopFuelScoredHigh5" value="1" class="mdl-radio__button"><span> Few</span></label>
									<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio" name="TeleopFuelScoredHigh5" id="TeleopFuelScoredHigh5" value="2" class="mdl-radio__button"><span> Less Than Half</span></label>
									<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio" name="TeleopFuelScoredHigh5" id="TeleopFuelScoredHigh5" value="3" class="mdl-radio__button"><span> Half</span></label>
									<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio" name="TeleopFuelScoredHigh5" id="TeleopFuelScoredHigh5" value="4" class="mdl-radio__button"><span> More Than Half</span></label>
									<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio" name="TeleopFuelScoredHigh5" id="TeleopFuelScoredHigh5" value="5" class="mdl-radio__button"><span> Most</span></label>
								</div>
							</center>
						</tr>
						<br>
						<tr>
							<center>
								<h5>Amount of balls scored in ShootingCycle 6</h5>
								<div class="mdl-shadow--2dp" style="padding:5px; width:70%">
									<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio" name="TeleopFuelScoredHigh6" id="TeleopFuelScoredHigh6" value="0" class="mdl-radio__button" checked<?php if($current_user != "admin") {?> required <?php }?>><span> None</span></label>
									<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio" name="TeleopFuelScoredHigh6" id="TeleopFuelScoredHigh6" value="1" class="mdl-radio__button"><span> Few</span></label>
									<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio" name="TeleopFuelScoredHigh6" id="TeleopFuelScoredHigh6" value="2" class="mdl-radio__button"><span> Less Than Half</span></label>
									<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio" name="TeleopFuelScoredHigh6" id="TeleopFuelScoredHigh6" value="3" class="mdl-radio__button"><span> Half</span></label>
									<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio" name="TeleopFuelScoredHigh6" id="TeleopFuelScoredHigh6" value="4" class="mdl-radio__button"><span> More Than Half</span></label>
									<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio" name="TeleopFuelScoredHigh6" id="TeleopFuelScoredHigh6" value="5" class="mdl-radio__button"><span> Most</span></label>
								</div>
							</center>
						</tr>
						<br>
						<tr>
							<center>
								<h5>Amount of balls scored in ShootingCycle 7</h5>
								<div class="mdl-shadow--2dp" style="padding:5px; width:70%">
									<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio" name="TeleopFuelScoredHigh7" id="TeleopFuelScoredHigh7" value="0" class="mdl-radio__button" checked<?php if($current_user != "admin") {?> required <?php }?>><span> None</span></label>
									<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio" name="TeleopFuelScoredHigh7" id="TeleopFuelScoredHigh7" value="1" class="mdl-radio__button"><span> Few</span></label>
									<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio" name="TeleopFuelScoredHigh7" id="TeleopFuelScoredHigh7" value="2" class="mdl-radio__button"><span> Less Than Half</span></label>
									<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio" name="TeleopFuelScoredHigh7" id="TeleopFuelScoredHigh7" value="3" class="mdl-radio__button"><span> Half</span></label>
									<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio" name="TeleopFuelScoredHigh7" id="TeleopFuelScoredHigh7" value="4" class="mdl-radio__button"><span> More Than Half</span></label>
									<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio" name="TeleopFuelScoredHigh7" id="TeleopFuelScoredHigh7" value="5" class="mdl-radio__button"><span> Most</span></label>
								</div>
							</center>
						</tr>
						<br>
						<tr>
							<center>
								<h5>Amount of balls scored in ShootingCycle 8</h5>
								<div class="mdl-shadow--2dp" style="padding:5px; width:70%">
									<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio" name="TeleopFuelScoredHigh8" id="TeleopFuelScoredHigh8" value="0" class="mdl-radio__button" checked<?php if($current_user != "admin") {?> required <?php }?>><span> None</span></label>
									<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio" name="TeleopFuelScoredHigh8" id="TeleopFuelScoredHigh8" value="1" class="mdl-radio__button"><span> Few</span></label>
									<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio" name="TeleopFuelScoredHigh8" id="TeleopFuelScoredHigh8" value="2" class="mdl-radio__button"><span> Less Than Half</span></label>
									<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio" name="TeleopFuelScoredHigh8" id="TeleopFuelScoredHigh8" value="3" class="mdl-radio__button"><span> Half</span></label>
									<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio" name="TeleopFuelScoredHigh8" id="TeleopFuelScoredHigh8" value="4" class="mdl-radio__button"><span> More Than Half</span></label>
									<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio" name="TeleopFuelScoredHigh8" id="TeleopFuelScoredHigh8" value="5" class="mdl-radio__button"><span> Most</span></label>
								</div>
							</center>
						</tr>
						<br>
						<tr>
							<center>
								<h5>Amount of balls scored in ShootingCycle 9</h5>
								<div class="mdl-shadow--2dp" style="padding:5px; width:70%">
									<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio" name="TeleopFuelScoredHigh9" id="TeleopFuelScoredHigh9" value="0" class="mdl-radio__button" checked<?php if($current_user != "admin") {?> required <?php }?>><span> None</span></label>
									<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio" name="TeleopFuelScoredHigh9" id="TeleopFuelScoredHigh9" value="1" class="mdl-radio__button"><span> Few</span></label>
									<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio" name="TeleopFuelScoredHigh9" id="TeleopFuelScoredHigh9" value="2" class="mdl-radio__button"><span> Less Than Half</span></label>
									<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio" name="TeleopFuelScoredHigh9" id="TeleopFuelScoredHigh9" value="3" class="mdl-radio__button"><span> Half</span></label>
									<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio" name="TeleopFuelScoredHigh9" id="TeleopFuelScoredHigh9" value="4" class="mdl-radio__button"><span> More Than Half</span></label>
									<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio" name="TeleopFuelScoredHigh9" id="TeleopFuelScoredHigh9" value="5" class="mdl-radio__button"><span> Most</span></label>
								</div>
							</center>
						</tr>
						<h5>ShootingCycles</h5>
						<div class="mdl-shadow--2dp" style="padding:5px; width:70%">
							<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" style="padding:1px 20px"><input type="radio"  name="ShootingCycles" id="ShootingCycles"  value="0" class="mdl-radio__button" checked<?php if($current_user != "admin") {?> required <?php }?>><span>0</span></label>
