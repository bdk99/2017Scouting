	...
	<div class="row">     
		<div class="col-lg-6" style="z-index: 9;">
			<div class="form-group">
				<input type="text" class="form-control input-lg" placeholder="First Name" name="user_firstname" minLength="3" maxLength="40" required>
			</div>
		</div>
		<div class="col-lg-6" style="z-index: 9;">
			<div class="form-group">
				<input type="text" class="form-control input-lg" placeholder="Last Name" name="user_lastname" minLength="3" maxLength="40" required>
			</div>
		</div>
			...
			<div class="form-group">
				<div class="input-group">
					<span class="input-group-addon">
						<!-- http://<?php echo $rws['domain_websiteaddress'];?>/user_username= --> Team3641/
					</span>
